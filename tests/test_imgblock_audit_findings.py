...
class TestFinding1TupleReturnNoThreadLocal:
    ...
    def test_finding1_finding6_docling_returns_tuple_with_neutral_md(self, monkeypatch):
        ...
        monkeypatch.setattr(
            converters, "_recover_picture_results", lambda md_, doc, path, filename=None, body_for_containment=None, expected_script=None, force_full_page_ocr_applied=False: [pr]
        )
