...
"""Tests for the arq worker: job lifecycle (WORKER-01), subprocess-isolated
converter boundary (Plan 01 / Phase 3), crash-safety resiliency (WORKER-02),
and internal helpers (DLQ push, process-group kill, registry dual-write,
