...
- [x] <a id="1-phase-1--shared-gate-and-exception-d1-d4"></a>1. Phase 1 — Shared Gate and Exception ([D1](../rfcs/039-hr3-egress-control-plane.md#d1-shared-boot-gate--validate_hr3_compliance), [D4](../rfcs/039-hr3-egress-control-plane.md#d4-zdrcomplianceerror-and-observability))
  ...
  *[RFC-039 §D1](../rfcs/039-hr3-egress-control-plane.md#d1-shared-boot-gate--validate_hr3_compliance) + [§D4 exception subclass](../rfcs/039-hr3-egress-control-plane.md#d4-zdrcomplianceerror-and-observability)*
  ...
  - [x] <a id="11-zdrcomplianceerror-and-validate-hr3-compliance-d1-d4"></a>1.1 Create `ZDRComplianceError` and `validate_hr3_compliance()` ([D1](../rfcs/039-hr3-egress-control-plane.md#d1-shared-boot-gate--validate_hr3_compliance), [D4](../rfcs/039-hr3-egress-control-plane.md#d4-zdrcomplianceerror-and-observability))
  ...
  - [x] <a id="12-worker-boot-gate-d1"></a>1.2 Wire worker boot gate ([D1](../rfcs/039-hr3-egress-control-plane.md#d1-shared-boot-gate--validate_hr3_compliance))
  ...
  - [x] <a id="13-test-boot-gate-d1"></a>1.3 Test boot gate ([D1](../rfcs/039-hr3-egress-control-plane.md#d1-shared-boot-gate--validate_hr3_compliance))
...
- [x] <a id="2-phase-2--egress-gates-d2-d3"></a>2. Phase 2 — Egress Gates ([D2](../rfcs/039-hr3-egress-control-plane.md#d2-docling-remote-egress-gates), [D3](../rfcs/039-hr3-egress-control-plane.md#d3-primary-llm-per-call-gate))
  ...
  *[RFC-039 §D2](../rfcs/039-hr3-egress-control-plane.md#d2-docling-remote-egress-gates) + [§D3](../rfcs/039-hr3-egress-control-plane.md#d3-primary-llm-per-call-gate)*
  ...
  - [x] <a id="21-docling-remote-egress-gates-d2"></a>2.1 Add Docling remote egress gates ([D2](../rfcs/039-hr3-egress-control-plane.md#d2-docling-remote-egress-gates))
  ...
  - [x] <a id="22-primary-llm-per-call-gate-d3"></a>2.2 Add primary LLM per-call gate ([D3](../rfcs/039-hr3-egress-control-plane.md#d3-primary-llm-per-call-gate))
  ...
  - [x] <a id="23-test-egress-gates-d2-d3"></a>2.3 Test egress gates ([D2](../rfcs/039-hr3-egress-control-plane.md#d2-docling-remote-egress-gates), [D3](../rfcs/039-hr3-egress-control-plane.md#d3-primary-llm-per-call-gate))
...
- [x] <a id="3-phase-3--observability-and-validation-d4"></a>3. Phase 3 — Observability and Validation ([D4](../rfcs/039-hr3-egress-control-plane.md#d4-zdrcomplianceerror-and-observability))

  *[RFC-039 §D4](../rfcs/039-hr3-egress-control-plane.md#d4-zdrcomplianceerror-and-observability)*

  - [x] <a id="31-compliance-block-observability-d4"></a>3.1 Wire compliance block observability ([D4](../rfcs/039-hr3-egress-control-plane.md#d4-zdrcomplianceerror-and-observability))
  ...
  - [x] <a id="32-test-observability-d4"></a>3.2 Test compliance observability ([D4](../rfcs/039-hr3-egress-control-plane.md#d4-zdrcomplianceerror-and-observability))
  ...
  - [x] <a id="33-integration-tests"></a>3.3 Integration tests
  ...
  - [x] <a id="34-final-checkpoint"></a>3.4 Final Checkpoint
