...
- [x] <a id="1-batch-1--isolated-fixes-d0-d3-d6-d8"></a>1. Batch 1 — Isolated Fixes ([RFC-029 D0](../rfcs/029-run12-arabic-garble-gates-and-extraction-quality.md#d0-nfkc-normalize-arabic-presentation-forms-before-garble-check), [D3](../rfcs/029-run12-arabic-garble-gates-and-extraction-quality.md#d3-strip-fence-markers-and-hr-separators-in-flat-extraction-path), [D6](../rfcs/029-run12-arabic-garble-gates-and-extraction-quality.md#d6-llm-judge-calibration-stability-and-severity-anchoring-rules), [D8](../rfcs/029-run12-arabic-garble-gates-and-extraction-quality.md#d8-cross-document-contamination-gate-for-zero-body-text-node-clusters))

  - [x] 1.1 <a id="11-nfkc-normalize-arabic-presentation-forms"></a>Add NFKC normalization for Arabic Presentation Forms in `_pre_inference_normalize`
  ...
  - [x] 1.2 <a id="12-bidi-coherence-check-for-visual-order-garble"></a>Add post-NFKC bidi-coherence check and `visual_order_garble` reason
  ...
  - [x]* 1.3 <a id="13-unit-tests-d0-nfkc-and-bidi"></a>Unit tests for D0 NFKC normalization and bidi-coherence check
  ...
  - [x] 1.4 <a id="14-strip-fence-and-hr-markers-in-flat-extraction"></a>Strip fence markers and HR separators in `route_and_extract_flat`
  ...
  - [x] 1.5 <a id="15-unit-test-d3-fence-hr-stripping"></a>Unit test for D3 fence/HR stripping
  ...
  - [x] 1.6 <a id="16-d6-phase-a-json-diff-verification"></a>D6 Phase A — verify byte-identity of cabinet_resolution_no_21 stored artifacts across runs
  ...
  - [x] 1.7 <a id="17-d6-phase-b-judge-calibration-rules"></a>D6 Phase B — add judge stability and severity-anchoring calibration rules (contingent on 1.6)
  ...
  - [x] 1.8 <a id="18-zero-body-text-contamination-gate"></a>Add zero-body-text node cluster contamination gate
  ...
  - [x] 1.9 <a id="19-unit-tests-d8-contamination-gate"></a>Unit tests for D8 contamination gate
...
- [x] <a id="3-batch-2--routing-decision-hardening-d1-d2"></a>3. Batch 2 — Routing Decision Hardening ([RFC-029 D1](../rfcs/029-run12-arabic-garble-gates-and-extraction-quality.md#d1-content-density-gate-prefer-flat-extraction-when-tree-is-thin), [D2](../rfcs/029-run12-arabic-garble-gates-and-extraction-quality.md#d2-post-ocr-garble-dilution-density-floor-for-scanned-arabic-pdfs))

  - [x] 3.1 <a id="31-content-density-gate-tree-vs-flat"></a>Add content-density comparison gate to tree-vs-flat decision
  ...
  - [x] 3.2 <a id="32-unit-and-parameterized-tests-d1"></a>Unit and parameterized tests for D1 density gate
  ...
  - [x] 3.3 <a id="33-scanned-density-floor-and-arabic-content-ratio-check"></a>Add chars-per-page density floor and Arabic-content-ratio check for scanned PDFs
  ...
  - [x] 3.4 <a id="34-unit-tests-d2-density-floor"></a>Unit tests for D2 scanned-density floor
...
- [x] <a id="4-checkpoint--batch-2"></a>4. Checkpoint — Batch 2
  ...
  - Ask the user if questions arise before proceeding.
- [x] <a id="5-batch-3--table-handling-d4-d7"></a>5. Batch 3 — Table Handling ([RFC-029 D4](../rfcs/029-run12-arabic-garble-gates-and-extraction-quality.md#d4-post-export-table-deduplication-for-docling-char-inflation), [D7](../rfcs/029-run12-arabic-garble-gates-and-extraction-quality.md#d7-tree-builder-table-aware-node-segmentation))

  - [x] 5.1 <a id="51-post-export-table-repair-pass"></a>Add post-export table-repair pass for Docling output
  ...
  - [x] 5.2 <a id="52-unit-tests-d4-table-dedup"></a>Unit tests for D4 table-repair pass
  ...
  - [x] 5.3 <a id="53-table-aware-node-segmentation"></a>Add table-aware node segmentation to tree-builder
  ...
  - [x] 5.4 <a id="54-unit-tests-d7-table-segmentation"></a>Unit tests for D7 table-node segmentation
...
- [x] <a id="6-checkpoint--batch-3"></a>6. Checkpoint — Batch 3
  ...
  - Ask the user if questions arise before proceeding.
- [x] <a id="7-batch-4--picture-enrichment-context-retention-d5ab"></a>7. Batch 4 — Picture Enrichment Context Retention ([RFC-029 D5](../rfcs/029-run12-arabic-garble-gates-and-extraction-quality.md#d5-retain-chart-image-context-when-picture-skip-gates-fire) parts a, b)

  - [x] 7.1 <a id="71-retain-png-and-clip-text-on-skip-gate"></a>Retain `png_bytes`/`clip_text` when `_recover_picture_text` skip gates fire
  ...
  - [x] 7.2 <a id="72-standalone-jpg-docling-text-passthrough"></a>Copy Docling-extracted text into `PictureResult.ocr_text` for standalone images
    ...
    - _Requirements: [Design Property 7: Picture-context retention](../designs/design-rfc029-run12-arabic-garble-gates-and-extraction-quality.md#property-7-picture-context-retention)_
  - [x] 7.3 <a id="73-unit-tests-d5ab"></a>Unit tests for D5(a,b) picture-context retention
...
- [x] <a id="8-checkpoint--batch-4"></a>8. Checkpoint — Batch 4

  - Run `uv run pytest tests/test_rfc029_d5ab.py -v` and verify all property tests (Property 7) pass
  - Ask the user if questions arise before proceeding.
- [x] <a id="9-batch-5--post-docling-chart-page-heuristic-d5c"></a>9. Batch 5 — Post-Docling Chart-Page Heuristic ([RFC-029 D5](../rfcs/029-run12-arabic-garble-gates-and-extraction-quality.md#d5-retain-chart-image-context-when-picture-skip-gates-fire) part c — independently deferrable)

  - [x] 9.1 <a id="91-chart-page-density-heuristic"></a>Add post-Docling low-text-density chart-page detection heuristic
    ...
    - _Requirements: [Design Property 7: Picture-context retention](../designs/design-rfc029-run12-arabic-garble-gates-and-extraction-quality.md#property-7-picture-context-retention)_
  - [x] 9.2 <a id="92-unit-test-d5c-chart-page-heuristic"></a>Unit test for D5(c) chart-page heuristic
...
- [x] <a id="10-final-checkpoint"></a>10. Final Checkpoint
