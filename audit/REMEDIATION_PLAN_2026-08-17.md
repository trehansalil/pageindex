...
| `src/pageindex_mcp/worker.py` | 674-701 | Pass verdict fields from job result, not MinIO re-read    | Add `verdict_fields: dict                                                                                                                                              | None = None`to`_upsert_registry_row`; merge into registry fields                                         |
