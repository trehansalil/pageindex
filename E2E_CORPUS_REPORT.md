<!-- Space: CITRA -->
<!-- Title: PageIndex E2E Corpus Report -->
<!-- Label: pageindex -->
<!-- Label: e2e -->
<!-- Confluence-Page-Id: 5091950595 -->
...
| 7  | `Haftpflicht-Allgemeine-Bedingungen.pdf.pdf`                          | `fb43f1a8` | `cab05ff2-8bf5-439f-9676-6fe9116b5b6a`Called plugin:atlassian:atlassian 2 times | MARGINAL       | tree     | `processed/fb43f1a8.json`      | 129 nodes, depth 1                 | Flat hierarchy — depth 1 despite 129 nodes     |
