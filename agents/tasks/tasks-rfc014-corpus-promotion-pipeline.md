...
- [x] <a id="1-batch-0--verdict-computation-d1"></a>1. Batch 0 — Verdict Computation ([D1](../rfcs/014-corpus-promotion-pipeline.md#d1--verdict-as-a-computed-pipeline-output))

  - [x] <a id="11-implement-tree-max-leaf-ratio"></a>1.1 Implement `_tree_max_leaf_ratio`
  ...
  - [x] <a id="12-implement-classify-verdict"></a>1.2 Implement `classify_verdict`
  ...
  - [x] <a id="13-implement-ocr-noise-ratio-and-hash-pipe-ratio"></a>1.3 Implement `ocr_noise_ratio` and `hash_pipe_ratio` sub-metrics
  ...
  - [x]* <a id="14-write-d1-unit-tests"></a>1.4 Write D1 unit tests
  ...
  - [x] <a id="15-checkpoint--batch-0"></a>1.5 Checkpoint — Batch 0
...
- [x] <a id="2-batch-1--persisted-verdict-state-d2"></a>2. Batch 1 — Persisted Verdict State ([D2](../rfcs/014-corpus-promotion-pipeline.md#d2--persisted-verdict-state))

  - [x] <a id="21-extend-meta-fields-and-save-doc-meta"></a>2.1 Extend `_META_FIELDS` and `save_doc_meta`
  ...
  - [x] <a id="22-registry-migration"></a>2.2 Registry migration
  ...
  - [x]* <a id="23-write-d2-tests"></a>2.3 Write D2 tests
...
- [x] <a id="3-batch-2--triggers-d3"></a>3. Batch 2 — Triggers ([D3](../rfcs/014-corpus-promotion-pipeline.md#d3--triggers-version-gated-idempotent))

  - [x] <a id="31-wire-classify-verdict-into-ingest-path"></a>3.1 Wire `classify_verdict` into the ingest path
  ...
  - [x] <a id="32-implement-promotion-sweep-cli"></a>3.2 Implement the version-gated backfill sweep
  ...
  - [x] <a id="33-add-recompute-verdicts-flag-to-preprocess-client"></a>3.3 Add `--recompute-verdicts` flag to `preprocess_client.py`
  ...
  - [x]* <a id="34-write-d3-tests"></a>3.4 Write D3 tests
...
- [x] <a id="4-batch-3--first-sweep-and-regression-gate-d4"></a>4. Batch 3 — First Sweep and Regression Gate ([D4](../rfcs/014-corpus-promotion-pipeline.md#d4--first-sweep-promotions-and-the--33-gate))

  - [x] <a id="41-configure-017-threshold"></a>4.1 Configure the 0.17 Category C promotion threshold
  ...
  - [x] <a id="42-run-first-corpus-sweep"></a>4.2 Run the first corpus sweep
  ...
  - [x] <a id="43-implement-marsoom-33-regression-gate"></a>4.3 Implement the مرسوم 33 Category E regression gate
  ...
  - [x]* <a id="44-write-d4-golden-file-tests"></a>4.4 Write D4 golden-file tests
  ...
  - [x] <a id="45-checkpoint--batch-3"></a>4.5 Checkpoint — Batch 3
