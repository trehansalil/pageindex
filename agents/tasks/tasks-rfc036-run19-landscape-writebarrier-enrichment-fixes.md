...
- [x] <a id="1-batch-0--critical-fixes-d0-d1-d2"></a>1. Batch 0 -- Critical Fixes (D0, D1, D2) ([RFC-036 D0](../rfcs/036-run19-run19-landscape-writebarrier-enrichment-fixes.md#d0-landscape-reextract-runaway-page-cap-thread-kill-splice-fix-and-fragmentation-guard), [RFC-036 D1](../rfcs/036-run19-run19-landscape-writebarrier-enrichment-fixes.md#d1-write-barrier-delay-cap-schedule-and-catch-persistencenotvisibleerror-in-save-callers), [RFC-036 D2](../rfcs/036-run19-run19-landscape-writebarrier-enrichment-fixes.md#d2-land-staged-d19-enrichment-density-preserve-fix), [Design Architecture Decisions](../designs/design-rfc036-run19-landscape-writebarrier-enrichment-fixes.md#architecture-decisions), [Design High-Level Pipeline Flow](../designs/design-rfc036-run19-landscape-writebarrier-enrichment-fixes.md#high-level-pipeline-flow))
  ...
  - [X] <a id="1-2-d0b-replace-threadpoolexecutor-with-daemon-or-subprocess"></a>1.2 D0b: Replace `ThreadPoolExecutor` with a killable daemon-thread pool or subprocess
  ...
  - [X] <a id="1-3-d0c-retune-landscape_char_threshold"></a>1.3 D0c: Re-tune `LANDSCAPE_CHAR_THRESHOLD` to require picture/graphic regions
  ...
  - [X] <a id="1-4-d0d-splice-landscape-markdown-at-page-position"></a>1.4 D0d: Splice landscape fallback markdown at correct page position
  ...
  - [X] <a id="1-5-d0e-singleton-ratio-guard-in-_segment_table_nodes"></a>1.5 D0e: Singleton-ratio fragmentation guard in `_segment_table_nodes`
  ...
  - [X] <a id="1-6-d1-reduce-write-barrier-delays-and-catch-persistencenotvisibleerror"></a>1.6 D1: Reduce write-barrier delays and catch `PersistenceNotVisibleError` in save callers
  ...
  - [X] <a id="1-7-d2-commit-staged-d19-enrichment-density-preserve"></a>1.7 D2: Commit the already-staged D19 enrichment density-preserve fix
  ...
  - [X] <a id="1-8-d0-unit-tests"></a>1.8 D0 unit tests
  ...
  - [X] <a id="1-9-d1-unit-tests"></a>1.9 D1 unit tests
...
- [X] <a id="1-10-checkpoint--batch-0"></a>1.10 Checkpoint -- Batch 0
...
- [x] <a id="2-batch-1--improvements-d3-d4"></a>2. Batch 1 -- Improvements (D3, D4) ([RFC-036 D3](../rfcs/036-run19-run19-landscape-writebarrier-enrichment-fixes.md#d3-rtl-reversal-add-flat-fallback-routing-instead-of-terminal-rejection), [RFC-036 D4](../rfcs/036-run19-run19-landscape-writebarrier-enrichment-fixes.md#d4-propagate-pictureresult-skip-metadata-to-image-blocks-and-suppress-false-enrichment-verdicts), [Design Architecture Decisions](../designs/design-rfc036-run19-landscape-writebarrier-enrichment-fixes.md#architecture-decisions), [Design High-Level Pipeline Flow](../designs/design-rfc036-run19-landscape-writebarrier-enrichment-fixes.md#high-level-pipeline-flow))
  ...
  - [x] <a id="2-2-d4-propagate-skip-metadata-and-suppress-false-verdicts"></a>2.2 D4: Propagate skip metadata to image blocks and suppress false enrichment verdicts
  ...
  - [x] <a id="2-3-d3-unit-tests"></a>2.3 D3 unit tests
  ...
  - [x] <a id="2-4-d4-unit-tests"></a>2.4 D4 unit tests
  ...
  - [x] <a id="2-5-d5-extend-arabic-heading-injection"></a>2.5 D5: Extend Arabic structural heading injection
  ...
  - [x] <a id="2-6-d5-unit-tests"></a>2.6 D5 unit tests
...
- [x] <a id="2-7-checkpoint--batch-1"></a>2.7 Checkpoint -- Batch 1
  ...
  - Ask the user if questions arise before proceeding.
- [x] <a id="3-batch-2--lower-priority-d6-d7"></a>3. Batch 2 -- Lower Priority (D6, D7)

  - [x] <a id="3-1-d6-depth-adequacy-scoring"></a>3.1 D6: Depth-adequacy scoring in classify_verdict
  ...
  - [x] <a id="3-2-d6-unit-tests"></a>3.2 D6 unit tests
  ...
  - [x] <a id="3-3-d7-ocr-spike-service-wrappers"></a>3.3 D7: OCR engine evaluation spike -- PaddleOCR and Docling OCR service wrappers
  ...
  - [x] <a id="3-4-d7-spike-evaluation"></a>3.4 D7: Run spike evaluation and write comparison report
...
- [x] <a id="3-5-checkpoint--batch-2"></a>3.5 Checkpoint -- Batch 2
